...
pubDate: 2025-10-06T02:00:00.000Z
...
featured: true
---
export const PageColour = "test-magenta"
...
## 2. Style.
At the moment I am going through my maximising my vertical realestate phase that was kicked off by theo showing off Zen Browser, and while I do like my current design, I think that my design that was made in html and CSS was better. There is a problem however, This design does not translate to mobile AT ALL.
### How does one have two designs at the same time, with the same code and not go nuts.
good question, I am yet to figure that out. I think that tailwinds sm, md and lg tags will come in handy but I am not too sure yet.i do think it will be a large pain to actually achieve.